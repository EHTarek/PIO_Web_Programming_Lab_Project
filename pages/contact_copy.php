    ...
    <div class="container my-shadow pt-2 pb-2" style="min-height:745px;">
        <div class="row">
            <div class="col-lg-6 col-md-12">
                ...
                <form method="POST" action="../inc/action.php" class="needs-validation" novalidate>
                    <div class="form-group px-2">
                        <label for="fname">Full name: *</label>
                        <input type="text" class="form-control" id="fname" name="fullname" placeholder="Your full name..." required >
